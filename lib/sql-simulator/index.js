...
var Simulator = /** @class */ (function () {
    ...
    Simulator.prototype.getStringOrExpression = function () {
        var regexp = new RegExp("^([\\w\\._\"\\(\\)]+)", "i");
        var result = this.findByRegExp(regexp);
        if (!result) {
    ...
    Simulator.prototype.getDataType = function () {
    ...
    Simulator.prototype.simulateAlterTable = function () {
        var _this = this;
        var _a;
        var tablespace = this.ifToken(["ALL IN TABLESPACE"], function () {
            // tableName
            _this.getIdentifier();
        ...
        var found = this.switchToken((_a = {
                RENAME: function () {
                    _this.ifToken(["CONSTRAINT"], function () {
                        ...
                        _this.getToken(["TO"]);
                        var newConstraintName = _this.getIdentifier();
                        var index = table.indexes.findIndex(function (index) { return index.name === constraintName; });
                        if (index === -1) {
            ...
            this.repeat(function () {
                _this.switchToken({
                    'DROP CONSTRAINT': function () {
                        var ifExists = false;
                        _this.ifToken(["IF EXISTS"], function () {
                            ifExists = true;
                        });
                        var constraintName = _this.getIdentifier();
                        var i = table.indexes.findIndex(function (index) { return index.name === constraintName; });
                        if (i === -1) {
                            if (ifExists) {
                    ...
                    ALTER: function () {
                        ...
                        _this.switchToken({
                            'SET DATA TYPE': function () {
                                var dataType = _this.getDataType();
    ...
    Simulator.prototype.getColumn = function (table) {
        ...
        this.ifToken(["PRIMARY KEY", "FOREIGN KEY", "UNIQUE", "CHECK"], function (token) {
            ...
            if (type === "foreignKey") {
                ...
                _this.repeat(function () {
                    var found = _this.switchToken({
                        'ON UPDATE': function () {
                            var actionType = _this.getToken(['CASCADE', 'RESTRICT', 'NO ACTION']);
            ...
            _this.repeat(function () {
                ...
                var found = _this.switchToken((_a = {},
                    ...
                    _a.DEFAULT = function () {
                        column.modifiers.default = _this.getStringOrExpression();
                    },
                    _a.UNIQUE = function () {
                        var index = {
                            type: "unique",
