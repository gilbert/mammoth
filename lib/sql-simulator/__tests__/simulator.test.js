...
describe("Simulator", function () {
    ...
    describe('Non-alter queries', function () {
        it('select should not alter types', function () {
            simulator.types = {};
            simulator.tables = {};
    ...
    describe("CREATE TABLE", function () {
        ...
        it("should create table if not exists with PRIMARY KEY", function () {
        ...
        it("should create table with column with foreign key constraint plus on update and delete clause", function () {
    ...
    describe("ALTER TABLE", function () {
        ...
        it("should namespace", function () {
            ...
            simulate(before, "ALTER TABLE ALL IN TABLESPACE foo OWNED BY role SET TABLESPACE new_tablespace NOWAIT", after);
        });
        ...
        it("should rename constraint", function () {
            var before = {
                foo: {
                    name: "foo",
                    columns: {
        ...
        it("should error if table does not exist", function () {
            expect(function () {
                simulate({}, "ALTER TABLE foo RENAME TO bar", {});
            }).toThrow();
        });
        it("should not error if table does not exist and using if exists clause", function () {
            simulate({}, "ALTER TABLE IF EXISTS foo RENAME TO bar", {});
        });
        it("should drop constraint", function () {
            var before = {
                foo: {
                    name: "foo",
                    columns: {
        ...
        it("should not error when constraint does not exist and drop constraint if exists", function () {
            var before = {
                foo: {
                    name: "foo",
                    columns: {
        ...
        it("should error when drop constraint and constraint does not exist", function () {
            expect(function () {
                var before = {
                    foo: {
                        name: "foo",
        ...
        it("should add column with constraints", function () {
            var before = {
                foo: {
                    name: "foo",
                    columns: {
            ...
            var query = "ALTER TABLE foo ADD COLUMN bar INTEGER PRIMARY KEY";
            var after = lodash_1.cloneDeep(before);
        ...
        it("should not error when drop column if exists when column does not exist", function () {
            var before = {
                foo: {
                    name: "foo",
                    columns: {
        ...
        it("alter column but could not find it", function () {
            expect(function () {
                var before = {
                    foo: {
                        name: "foo",
        ...
        it("should alter column set data type with multiple identifiers", function () {
            var before = {
                account: {
                    name: "account",
                    columns: {
            ...
            var query = "ALTER TABLE account ALTER COLUMN id SET DATA TYPE TIMESTAMP WITHOUT TIME ZONE";
            var after = lodash_1.cloneDeep(before);
            after.account.columns.id.dataType = "TIMESTAMP WITHOUT TIME ZONE";
            simulate(before, query, after);
        });
        it("should alter column type with multiple identifiers", function () {
            var before = {
                account: {
                    name: "account",
                    columns: {
            ...
            var query = "ALTER TABLE account ALTER COLUMN id TYPE TIMESTAMP WITHOUT TIME ZONE";
            var after = lodash_1.cloneDeep(before);
            after.account.columns.id.dataType = "TIMESTAMP WITHOUT TIME ZONE";
            simulate(before, query, after);
        });
