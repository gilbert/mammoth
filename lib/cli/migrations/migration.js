...
exports.getMigrations = function (migrationsDir) {
    return fs
        ...
        .map(function (migrationName) { return (__assign({}, require(path.join(process.cwd(), migrationsDir, migrationName)), { name: migrationName })); });
};
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                if (error_1.code === schemaAlreadyExistsErrorCode ||
                    error_1.sqlState === schemaAlreadyExistsErrorCode) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (migrationName) {
                    return [2 /*return*/, __assign({}, require(path.join(process.cwd(), migrationsDir, migrationName)), { name: migrationName })];
                }
                return [2 /*return*/, undefined];
        }
    });
}); };
exports.getAllAppliedMigrations = function (db, migrationsDir) { return __awaiter(_this, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db.sql(templateObject_4 || (templateObject_4 = __makeTemplateObject(["SELECT name FROM db.migration"], ["SELECT name FROM db.migration"])))];
            case 1:
                result = _a.sent();
                return [2 /*return*/, result.rows
                        .map(function (row) { return row.name; })
                        .sort(function (a, b) { return getMigrationTimestamp(b) - getMigrationTimestamp(a); })
                        .map(function (migrationName) { return (__assign({}, require(path.join(process.cwd(), migrationsDir, migrationName)), { name: migrationName })); })];
        }
    });
}); };
