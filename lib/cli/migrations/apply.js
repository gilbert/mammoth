        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                if (unappliedMigrations.length === 0) {
                    console.log(chalk_1.default.green("All migrations already applied."));
                    return [2 /*return*/];
                }
            ...
            case 4:
                ...
                if (process.env.NODE_ENV !== "test") {
                    console.log(chalk_1.default.green("Successfully applied " + unappliedMigrations.length + " migrations."));
                }
                return [3 /*break*/, 6];
            case 5:
                e_1 = _a.sent();
